    ...
    <div className="grid grid-cols-2 gap-4">
      <div className="stat place-items-center bg-white dark:bg-gray-700 rounded-lg p-4 shadow-md dark:shadow-gray-600">
        ...
        <div className="flex items-center gap-2">
          <FaPoundSign className=" dark:text-neutral-300 h-8 w-8" />
          <div className=" dark:text-neutral-300 stat-value">{house.ppw}</div>
        </div>
      </div>
      ...
      <div className="stat place-items-center bg-white dark:bg-gray-700 rounded-lg p-4 shadow-md dark:shadow-gray-600">
        ...
        <div className="flex items-center gap-4">
          <div className=" dark:text-neutral-300 stat-value">
            {house.bathrooms}
          </div>
          <FaBath className=" dark:text-neutral-300 h-8 w-8" />
        </div>
      </div>
      ...
      <div className="stat place-items-center bg-white dark:bg-gray-700 rounded-lg p-4 shadow-md dark:shadow-gray-600">
        ...
        <div className="flex items-center gap-4">
          ...
          <FaCalendarWeek className=" dark:text-neutral-300 h-8 w-8" />
        </div>
      </div>
      ...
      <div className="stat place-items-center bg-white dark:bg-gray-700 rounded-lg p-4 shadow-md dark:shadow-gray-600">
        ...
        <div className="flex items-center gap-4">
          ...
          <FaBed className=" dark:text-neutral-300 h-8 w-8" />
        </div>
      </div>
      ...
      <div className="stat place-items-center bg-white dark:bg-gray-700 rounded-lg p-4 shadow-md dark:shadow-gray-600 col-span-2">
        ...
        <div className="flex items-center gap-1">
          <div className=" dark:text-neutral-300 stat-value flex items-center">
            {house.rating}
          </div>
          <StarRating size={30} />
        </div>
