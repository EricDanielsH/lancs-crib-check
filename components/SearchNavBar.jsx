    ...
    <section className="max-w-full flex h-fit flex-col items-center rounded-lg">
      <div className="w-full z-10">
        <div className="relative flex w-full  items-stretch bg-base-100 rounded-lg">
          <input
            type="search"
            className="relative m-0 block flex-auto rounded-lg border border-solid border-neutral-300 bg-transparent bg-clip-padding px-3 py-[0.25rem] text-base font-normal leading-[1.6] text-neutral-700 outline-none transition duration-200 ease-in-out focus:z-[3] focus:border-primary focus:text-neutral-700 focus:shadow-[inset_0_0_0_1px_rgb(59,113,202)] focus:outline-none "
            placeholder="Search"
            aria-label="Search"
          ...
          {/* <!--Search icon--> */}
          <span
            className="input-group-text flex items-center whitespace-nowrap rounded-lg px-3 py-1.5 text-center text-base font-normal text-neutral-700 "
            id="basic-addon2"
          >
            <svg
